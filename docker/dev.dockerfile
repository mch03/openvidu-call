...
RUN wget "https://github.com/mch03/openvidu/archive/master.zip" -O openvidu-browser.zip && \
...
RUN wget "https://github.com/mch03/openvidu-call/archive/${BRANCH_NAME}.zip" -O openvidu-call.zip && \
